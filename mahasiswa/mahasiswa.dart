...
import 'package:service/mahasiswa/insertMahasiswa.dart';
import 'package:service/mahasiswa/updateMahasiswa.dart';
import 'package:service/nilai/nilaiMahasiswa.dart';
...
class _DataMahasiswaState extends State<DataMahasiswa> {
  ...
  Future<void> allMahasiswa() async {
    String urlMahasiswa = "http://192.168.1.3:9001/api/v1/mahasiswa";
    try {
  ...
  Future<void> deleteMahasiwa(int id) async {
    String urlMahasiswa = "http://192.168.1.3:9001/api/v1/mahasiswa/${id}";
    try {
